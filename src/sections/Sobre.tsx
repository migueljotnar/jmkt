export default function Sobre() {
  return (
    <section id="sobre" className="max-w-[1100px] mx-auto px-4 sm:px-8 py-12 sm:py-20">
      <h2 className="text-3xl sm:text-4xl text-center mb-6 sm:mb-8">Sobre Mim</h2>
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 text-center md:text-left">
        <img
          ...
          alt="Jessyane Soares"
          className="w-full max-w-[400px] h-[350px] sm:h-[450px] md:h-[550px] object-cover rounded flex-shrink-0"
        />
        <div>
          <h3 className="text-xl sm:text-2xl mb-2">Olá, eu sou a Jessyane!</h3>
          <p>
